...
public class TrafficLightBuilder <B extends TrafficLightBuilder<B>> {
    ...
    public final B upperColor(final LightColor COLOR) {
    ...
    public final B middleColor(final LightColor COLOR) {
    ...
    public final B lowerColor(final LightColor COLOR) {
    ...
    public final TrafficLight build() {
        ...
        properties.forEach((key, property) -> {
            if ("prefSize".equals(key)) {
                ...
                CONTROL.setUpperColor(((ObjectProperty<LightColor>) properties.get(key)).get());
                ...
                CONTROL.setMiddleColor(((ObjectProperty<LightColor>) properties.get(key)).get());
                ...
                CONTROL.setLowerColor(((ObjectProperty<LightColor>) properties.get(key)).get());
